...
4. git checkout -b main Отслеживать main
...
15.
16.
17. Создаём репозиторий на GITVERSE и связываем его с проектом
18.
19. git remote add origin ssh://git@gitverse.ru:2222/Martin937/Family_Tree.git Прописываем путь к gitverse
20. git remote set-url origin https://gitverse.ru/Martin937/Family_Tree.git Если нужно изменить уже существующий
21. git push -u origin master Заливка на gitverse
22. git pull Обновление всех связей и изменений
23. git push Заливка на gitverse
24.
25.
26. git remote set-url origin ssh://git@gitverse.ru:2222/Martin937/Family_Tree.git Подключение по SSH
27.
